...
Review.create!([{property_id: Property.first.id,user_id: User.last.id,description:"Great environment, professional and nice people, clean and beautiful office set up"},
